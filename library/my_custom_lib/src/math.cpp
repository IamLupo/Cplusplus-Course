...
long long MyCustomLib::Math::gcd(long long a, long long b)
{
	long long c;
...
long long MyCustomLib::Math::gcdr(long long a, long long b)
{
	if (a == 0)
		return b;
...
*/
long long MyCustomLib::Math::phi(long long n)
{
	long long r;
	long long i;
...
*/
long long MyCustomLib::Math::factorial(long long n)
{
	long long i, r;
...
*/
long long MyCustomLib::Math::binomial_coefficient(unsigned long n, unsigned long k)
{
    unsigned long i;
    long long b;
